...
class Student {
  ...
  String? getName() => name;
  int? getAdmNo() {
    //same as using the return function.
    return admNo;
  }
...
void main() {
  Student degreeStudent =
      new Student.degreeStudent('Ray', 003, 20, '0746481374', 'Social arts');
  Student dipolmaStudent = new Student.dipStudent('Darwins', 18, '0711734971',
      'Full-stake softwaredeveloper', 'Kakamega school');
  Student mastersStudent =
      new Student.mastersStudent('Jack', 19, 'jackopondo@gmail.com');
  studentsown();
